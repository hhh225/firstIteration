...
public class Form_6_2_FrontConsume extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		resp.setContentType("text/html; charset="+ DemoBase.encoding);   //set the response 
		
		//前台页面传过来的
		String merId = req.getParameter("merId");     //POS number
		String txnAmt = req.getParameter("txnAmt");    //money to pay
		String orderId = req.getParameter("orderId");    //order number
		String txnTime = req.getParameter("txnTime");    //time of paying
